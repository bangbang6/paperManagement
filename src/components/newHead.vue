  ...
  <div class="head">
    ...
    <div class="nav" @click="navJump">
      ...
      <el-dropdown style="color: white;" trigger="click">
        <div v-if="role===0" :class="['nav-item',navIndex === 2?'green':'']">
          上传成果
      ...
      <el-dropdown style="color: white;" trigger="click" v-if="role===0">
        <div :class="['nav-item',navIndex === 4?'green':'']">
          ...
          <el-dropdown-menu slot="dropdown">
            <div @click="navJump">
              <el-dropdown-item data-item="41" v-if="role===0">链上论文</el-dropdown-item>
            </div>
            <div @click="navJump">
      ...
      <el-dropdown style="color: white;" trigger="click" v-if="role===1">
        <div :class="['nav-item',navIndex === 4?'green':'']">
          ...
          <el-dropdown-menu slot="dropdown">
            <div @click="navJump">
              <el-dropdown-item data-item="41" v-if="role===1">链上论文</el-dropdown-item>
            </div>
            <div @click="navJump">
